            ...
            <div className="mt-10">
                ...
                serializers={{
                        ...
                        link: ({href, children}: any) => {
                            <a href={href} className="text-blue-500 bover:underline">{children}</a>
                        }}
                }
                />
            </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
            ...
            <label className="block mb-5">
                ...
                <input 
                    ...
                    className="shadow border rounded py-2 px-2 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring" 
...
export const getStaticProps: GetStaticProps = async ({params}) => {
    const query = `*[_type == "post" && slug.current == $slug][0]  {
      ...
      return {
        ...
        revalidate: 60, // after 60 seconds, itll update the cache
      }
}